...
student_franka = codecool_bp.find_student_by_full_name(codecool_bp.get_random_student())
student_gyuri = codecool_bp.find_student_by_full_name(codecool_bp.get_random_student())
student_owen = codecool_bp.find_student_by_full_name(codecool_bp.get_random_student())
student_dani = codecool_bp.find_student_by_full_name(codecool_bp.get_random_student())
student_miki = codecool_bp.find_student_by_full_name(codecool_bp.get_random_student())
